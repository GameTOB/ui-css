	...
	<div class="panel-body element-con clearfix">
		<div class="clearfix">
			...
			<div class="col-xs-2">
				...
				<div class="select-drop select-with-searchbox select-drop-active select-drop-above" style="width: 244px; display: block;" id="select-drop">
					<div class="select-search">
						<input type="text" autocomplete="off" class="select-input">
					</div>
					<ul class="select-results">
						<li class="select-result select-result-selectable">
							<div class="select-result-label">
								<span class="select-match"></span>5
							</div>
						</li>
						<li class="select-result select-result-selectable select-highlighted">
							<div class="select-result-label">
								<span class="select-match"></span>15
							</div>
						</li>
						<li class="select-result select-result-selectable">
							<div class="select-result-label">
								<span class="select-match"></span>20
							</div>
						</li>
						<li class="select-result select-result-selectable">
							<div class="select-result-label">
								<span class="select-match"></span>All
							</div>
						</li>
					</ul>
				</div>
