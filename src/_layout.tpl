    ...
    <body>
        ...
        <header id="header">
            ...
            <ul class="nav navbar-nav navbar-default pull-right">
                <li><a href="#"><i class="fa fa-user fa-lg"></i></a>
            </li>
            <li><a href="#"><i class="fa fa-repeat fa-lg"></i></a>
        </li>
    </ul>
</header>
<!-- header -->
    ...
    <nav id="aside">
        <ul class="nav">
            ...
            <a href="uielement.html">
                <i class="fa fa-usd"></i>
                <span class="nav-label">基础元素</span>
